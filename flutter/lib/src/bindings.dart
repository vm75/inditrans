...
class InditransBindings {
  ...
  ffi.Pointer<ffi.Uint8> transliterate(
    ...
    return _transliterate(text, from, to, options, skipStart, skipEnd);
  }
  ...
  late final _transliteratePtr =
      _lookup<
        ...
        >
      >('transliterate');
  late final _transliterate = _transliteratePtr
      .asFunction<
        ffi.Pointer<ffi.Uint8> Function(
          ffi.Pointer<ffi.Uint8>,
          ffi.Pointer<ffi.Uint8>,
  ...
  int isScriptSupported(ffi.Pointer<ffi.Uint8> script) {
    return _isScriptSupported(script);
  }
  ...
  late final _isScriptSupported = _isScriptSupportedPtr
  ...
  late final _releaseBuffer = _releaseBufferPtr
